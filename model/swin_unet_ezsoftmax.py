...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, num_patches, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.qk = nn.Linear(dim, 2 * num_heads * (num_patches // 4), bias=qkv_bias)
    ...
    def forward(self, x, mask=None):
        ...
        qk = self.qk(x).reshape(B_, N, self.num_heads, N // 4, 2).permute(4, 0, 2, 1, 3) 
        q, k = qk[0], qk[1]  # make torchscript happy (cannot use tensor as tuple)## B, nH, N, C/heads
        q = q * self.scale
